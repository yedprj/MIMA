		...
		<div class="profile-box">
			<div class="upper-box">
				...
				<div class="title-box centred">
					<div class="inner">
						...
						<p>${profile.${profile.pharmacyInfo}}</p>
					</div>
				</div>
			</div>
			<div class="profile-info">
				<ul class="list clearfix">
					...
					<li><a id="delivery" href="${pageContext.request.contextPath}/pharmacy/medDelivery" class="current"><i class="fas fa-ambulance"></i>약배달관리</a></li>
