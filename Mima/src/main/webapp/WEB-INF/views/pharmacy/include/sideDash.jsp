		...
		<div class="profile-box">
			...
			<div class="profile-info">
				<ul class="list clearfix">
					...
					<li><a href="${pageContext.request.contextPath}/pharmacy/myProfile"><i class="fas fa-user"></i>약국 프로필</a></li>
					<li><a href="${pageContext.request.contextPath}/pharmacy/pwUpdate"><i
