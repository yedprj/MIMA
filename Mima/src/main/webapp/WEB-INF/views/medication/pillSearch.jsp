...
<script>
	...
	$(function() {
		...
		// + 검색 조건 추가 ,카테고리별 검색 조건 찾기
		
		// 품목기준코드 : 숫자 모두 포함되는 조건의 약을 검색함
		
		// 제품명 : 한글자, 두글자시 검색 되는 조건이 너무 많음 -> 최소 두글자 이상이 되도록, 또는 세글자
		
		// 효능 : 생각보다 검색 되는 기능이 많지는 않음 , 좀 더 검색 조건을 찾아보기
		
		// 상호작용 : 음식이나 약을 검색하면 나오기 때문에 음식이나 약 종류가 아니면 리턴시키기
