                    ...
                    <div class="outer-container">
                        ...
                        <div class="doctors-appointment">
                            <div class="title-box">
                                <h3>오늘의 예약</h3>
                                <div class="btn-box">
                                    <a href="apptManage" class="theme-btn-one">예약관리<i class="icon-Arrow-Right"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="doctors-appointment">
                            <div class="title-box">
                                <h3>나의 후기</h3>
                                <div class="btn-box">
                                <a href="patient-dashboard.html" class="theme-btn-one">전체보기<i class="icon-Arrow-Right"></i></a>
                                </div>
                            </div>
                            <div class="doctors-list">
                                <div class="table-outer">
