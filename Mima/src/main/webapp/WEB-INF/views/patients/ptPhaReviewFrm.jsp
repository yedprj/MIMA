                ...
                <div class="review-box">
                    <div class="content-box">
                        <div class="title-inner">
                            <h3>Write a Review for Pharmacy.${pha.pharmacyName } </h3>
                        ...
                        <div class="content-inner">
                            ...
                            <div class="form-inner">
                                ...
                                <input type="hidden" id="cmainCategory" name="cmainCategory" value="pha" >
                                <!-- 의사 번호 (이건 예약번호로 조회해서 넣어주기) -->
                                 <input type="hidden" id="cmainNo" name="cmainNo" value="${pha.pharmacyNo }" >
                                 <input type="hidden" id="bookingNo" name="bookingNo" value="${pha.bookingNo }" >
